        ...
        <div className="max-w-lg w-full p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="p-6 rounded-xl border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 text-left transition-all"
            >
              <div className="text-2xl mb-3">🧑‍💼</div>
              <h3 className="font-semibold text-gray-900 mb-1">Tək işləyirəm</h3>
            ...
            >
              <div className="text-2xl mb-3">👥</div>
              <h3 className="font-semibold text-gray-900 mb-1">Komandamız var</h3>
              <p className="text-sm text-gray-500">
